...
/**
 * remove_reading_space - removing extra space characters
 *
 * @buffer: double pointers to the locations reading characters from
 *
...
/**
 * _memset - used to sets a block of memories with a particulars values.
 *
