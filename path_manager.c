...
/**
 * _cmd_abs_path - creating absolute absolute the path for the commands and
 *
 * tests if the files path is executable.
 *
 * @cmdname: pointer to the commands to creates absolute path for.
 *
